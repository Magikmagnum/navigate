...
export function SkillDashBoard(props) {
    return (
        <View style={{
            ...
            < RealCardBottom title="experience" note={props.experience} icon='md-star' />
...
function RealCardBottom(props) {
    return (
        <View style={{ flexDirection: 'column', minWidth: 64, paddingHorizontal: 20, height: 48, justifyContent: "center", alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 12, fontWeight: 'bold', color: '#999' }}>{props.note}</Text>
            <Text style={{ fontSize: 12, fontWeight: 'bold', color: '#999' }}>{props.title}</Text>
        </View>
    )
}
